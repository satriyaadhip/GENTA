                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('skd/proses') ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="user_nama" class="form-control" value="<?= set_value('user_nama') ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label for="">NIK</label>
                                            <input type="number" name="user_nik" class="form-control" value="<?= set_value('user_nik') ?>" />
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="">Tempat Lahir</label>
                                                    <input type="text" name="user_tempatlahir" class="form-control" value="<?= set_value('user_tempatlahir') ?>" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="">Tanggal Lahir</label>
                                                    <input type="date" name="user_ttl" class="form-control" value="<?= set_value('user_ttl') ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="user_pekerjaan" class="form-control" value="<?= set_value('user_pekerjaan') ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label for="">Alamat rumah</label>
                                            <textarea name="user_alamat" id="" cols="30" rows="5" class="form-control" required><?= set_value('user_alamat') ?></textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="">RT</label>
                                                    <input type="number" name="user_rt" class="form-control" value="<?= set_value('user_rt') ?>" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="">RW</label>
                                                    <input type="number" name="user_rw" class="form-control" value="<?= set_value('user_rw') ?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
